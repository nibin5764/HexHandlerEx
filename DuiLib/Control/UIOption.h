...
namespace DuiLib
{
	...
	public:
		...
		void SetSelectedFont(DWORD dwFont);
		DWORD GetSelectedFont();

		void SetSelectedUnderlineColor(DWORD dwColor);
		DWORD GetSelectedUnderlineColor();
	...
	protected:
		...
		int				m_SelectedFont;		//选中时的字体
		DWORD			m_SelectedUnderLineColor;	//选中时下划线颜色
